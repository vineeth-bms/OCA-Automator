...
public class Main2 {
    ...
    public static DefaultTableModel playConfigs(String FilePath) {
        ...
        if (!sheetNames.isEmpty()) {
            ...
            for (String sheetName : sheetNames) {
               ...
               // str = OCA_SDriver.testConfig(exlFilePath, sheetName);
                results.add(str);
            }
            ...
            for (int i = 0; i < results.size(); i++) {
                ...
                model.addRow(new Object[]{ExcelUtils.getFileName(exlFilePath), ExcelUtils.getTitle(exlFilePath, sheetNames.get(i)), results.get(i)});
            }
    ...
    public static void main(String[] args) {
        ...
        saveButton.addActionListener(e -> {
            ...
            String recommendedFileName = "result_of"  + "+" + selectedFiles.size() + "files.xlsx";
